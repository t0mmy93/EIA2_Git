...
(function (unoonline4) {
    ...
    // ende plusTwo
    let swapDirectionRed1 = {
        name: "swapDirection",
        color: "#ff0000",
        value: 10
    };
    let swapDirectionRed2 = {
        name: "swapDirection",
        color: "#ff0000",
        value: 10
    };
    let swapDirectionGreen1 = {
        name: "swapDirection",
        color: "#00ff00",
        value: 10
    };
    let swapDirectionGreen2 = {
        name: "swapDirection",
        color: "#00ff00",
        value: 10
    };
    let swapDirectionBlue1 = {
        name: "swapDirection",
        color: "#0000ff",
        value: 10
    };
    let swapDirectionBlue2 = {
        name: "swapDirection",
        color: "#0000ff",
        value: 10
    };
    let swapDirectionYellow1 = {
        name: "swapDirection",
        color: "#ffff00",
        value: 10
    };
    let swapDirectionYellow2 = {
        name: "swapDirection",
        color: "#ffff00",
        value: 10
    };
