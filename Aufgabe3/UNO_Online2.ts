...
namespace unoonline4 {
    ...
    function main(): void {
        ...
        for (let d: number = 0; j > d; d++) {
            ...
            console.log(color);
            let name: string = str.substring(7, 14);                        // Name wird aus dem Array gezogen
            console.log(name);
